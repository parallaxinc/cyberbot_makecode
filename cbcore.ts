...
namespace cyberbot {
    ...
    * @param pin Pin connected to the speaker, eg: cyberbot.PiezoPin.P22
    ...
    * @param pin Cyberbot pin connected to the speaker, eg: cyberbot.PiezoPin.P22
    ...
    */
     ...
     * @param pin The cyberbot pin connected to the servo, eg: cyberbot.ServoPin.P18
    ...
    */
    ...
    //  * @param pin The cyberbot pin connected to the PING))), eg: cyberbot.ServoPin.P16
